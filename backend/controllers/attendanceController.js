...
export const checkIn = async (req, res, next) => {
    try {
        ...
        workStartTime.setHours(9,30,0,0); // Assume work starts at 9.30 AM
...
export const checkOut = async (req, res, next) => {
    try {
        ...
        const workingMilliseconds = checkOutTime - attendance.checkInTime;
...
export const getTodayAttendance = async (req,res,next) => {
    ...
    const attendance = await Attendance.findOne({
        ...
        res.status(200).json({
            ...
            hasCheckOut : attendance ? !!attendance.checkOutTime : false
        });
...
export const getAttendanceById = async (req, res, next) => {
    try {
        ...
        if (attendance.employee._id.toString() !== req.user._id.toString() && 
